...
describe AulasController do
  ...
  let(:valid_attributes) { { "data_abertura" => "MyString" } }
  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved aula as @aula" do
        ...
        post :create, {:aula => { "data_abertura" => "invalid value" }}, valid_session
        assigns(:aula).should be_a_new(Aula)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested aula" do
        ...
        Aula.any_instance.should_receive(:update).with({ "data_abertura" => "MyString" })
        put :update, {:id => aula.to_param, :aula => { "data_abertura" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the aula as @aula" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Aula.any_instance.stub(:save).and_return(false)
        put :update, {:id => aula.to_param, :aula => { "data_abertura" => "invalid value" }}, valid_session
        assigns(:aula).should eq(aula)
      end
