  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved professor as @professor" do
        ...
        post :create, {:professor => { "matricula" => "invalid value" }}, valid_session
        assigns(:professor).should be_a_new(Professor)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested professor" do
        ...
        Professor.any_instance.should_receive(:update).with({ "matricula" => "MyString" })
        put :update, {:id => professor.to_param, :professor => { "matricula" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the professor as @professor" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Professor.any_instance.stub(:save).and_return(false)
        put :update, {:id => professor.to_param, :professor => { "matricula" => "invalid value" }}, valid_session
        assigns(:professor).should eq(professor)
      end
